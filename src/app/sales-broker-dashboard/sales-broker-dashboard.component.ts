...
@Component({
  selector: 'app-sales-broker-dashboard',
  templateUrl: './sales-broker-dashboard.component.html',
  styleUrls: ['./sales-broker-dashboard.component.scss']
})
export class SalesBrokerDashboardComponent implements OnInit {
